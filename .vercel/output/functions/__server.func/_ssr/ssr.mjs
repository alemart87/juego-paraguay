...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dvk56J7f.mjs");
...
var manifest = {
	"4827ca590fa65ad9bacff161c271da834d9a1de91f3f0ec67edc9c19edb2bd60": {
		functionName: "chatWithNpc_createServerFn_handler",
		importer: () => import("./agent-D522uMMh.mjs")
	},
	"e8422483ec6fdd0a5658777b451994d595ccfec8df5554f3d20a70d68112541e": {
		functionName: "pingVenice_createServerFn_handler",
		importer: () => import("./agent-D522uMMh.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BevuN0dQ.mjs").then((n) => n.t),
