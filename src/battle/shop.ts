...
export const getWhopCheckout = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    const env: Record<ShopSku, string | undefined> = {
      ...
      "rivas-golpes-500": process.env.WHOP_CHECKOUT_RIVAS_GOLPES_500,
      "rivas-golpes-2500": process.env.WHOP_CHECKOUT_RIVAS_GOLPES_2500,
      "rivas-golpes-6000": process.env.WHOP_CHECKOUT_RIVAS_GOLPES_6000,
