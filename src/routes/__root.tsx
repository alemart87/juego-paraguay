...
const DESCRIPTION =
  "Elegí tu influencer, dominá cinco escenarios paraguayos y enfrentá jefes imposibles en una batalla arcade creada para móvil. Bono de Gs 5.000.000 para los mejores del ranking.";
